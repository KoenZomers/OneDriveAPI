...
{
    /// <summary>
    /// API for SharePoint Online site collections
    /// Create your own Client ID / Client Secret at https://apps.dev.microsoft.com
    /// </summary>
    public class SharePointApi : OneDriveApi
    {
        #region Constants
        ...
        /// </summary>
        public override string AuthenticationRedirectUrl { get; set; } = "https://login.windows.net/common/oauth2/nativeclient";

        /// <summary>
        /// String formatted Uri that needs to be called to authenticate to the Graph API
        /// </summary>
        protected override string AuthenticateUri => "https://login.windows.net/common/oauth2/authorize?response_type=code&client_id={0}&redirect_uri={1}";
        
        /// <summary>
        /// String formatted Uri that can be called to sign out from the Graph API
        /// </summary>
        public override string SignoutUri => "https://login.microsoftonline.net/common/oauth2/logout";

        /// <summary>
        /// The url where an access token can be obtained
        /// </summary>
        protected override string AccessTokenUri => "https://login.windows.net/common/oauth2/token";
        ...
        /// <summary>
        /// Base URI of the SharePoint site to connect to
        /// </summary>
        protected Uri SharePointSiteBaseUri { get; set; }
        ...
        /// <summary>
        /// Instantiates a new instance of the SharePoint API
        /// </summary>
        /// <param name="applicationId">Microsoft Application ID to use to connect</param>
        /// <param name="clientSecret">Application Secret generated for the Application ID</param>
        /// <param name="sharePointSiteUri">Uri of the SharePoint site to connect to</param>
        public SharePointApi(string applicationId, string clientSecret, Uri sharePointSiteUri) : base(applicationId, clientSecret)
        {
            SharePointSiteBaseUri = sharePointSiteUri;
        }
        ...
        /// <returns>Access token for the SharePoint API</returns>
        ...
        {
            return await GetAccessTokenFromAuthorizationToken(authorizationToken, SharePointSiteBaseUri);
        }
        ...
        /// </summary>
        /// <param name="authorizationToken">Authorization token</param>
        /// <param name="sharePointSiteUrl">SharePoint site to request access to</param>
        /// <returns>Access token for the SharePoint API</returns>
        /// <exception cref="Exceptions.TokenRetrievalFailedException">Thrown when unable to retrieve a valid access token</exception>
        protected async Task<OneDriveAccessToken> GetAccessTokenFromAuthorizationToken(string authorizationToken, Uri sharePointSiteUrl)
        {
            var queryBuilder = new QueryStringBuilder();
            queryBuilder.Add("client_id", ClientId);
            queryBuilder.Add("resource", sharePointSiteUrl.ToString());
        ...
        /// </summary>
        /// <param name="refreshToken">Refresh token</param>
        /// <param name="sharePointUri">Uri of the SharePoint site to request access to </param>
        /// <returns>Access token for the Graph API</returns>
        /// <exception cref="Exceptions.TokenRetrievalFailedException">Thrown when unable to retrieve a valid access token</exception>
        protected async Task<OneDriveAccessToken> GetAccessTokenFromRefreshToken(string refreshToken, Uri sharePointUri)
        {
            var queryBuilder = new QueryStringBuilder();
            queryBuilder.Add("client_id", ClientId);
            queryBuilder.Add("resource", sharePointUri.ToString());
        ...
        #region Public Methods - SharePoint API Only
